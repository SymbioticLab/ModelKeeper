...
__all__ = ['CIFARRoR', 'ror3_56_cifar10', 'ror3_56_cifar100', 'ror3_56_svhn', 'ror3_110_cifar10', 'ror3_101_cifar10','ror3_110_cifar100',
...
def ror3_101_cifar10(num_classes=10, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    return get_ror_cifar(num_classes=num_classes, blocks=101, model_name="ror3_101_cifar10", **kwargs)
