...
parser.add_argument('--zoo_path', type=str, default='/gpfs/gpfs0/groups/chowdhury/fanlai/model_zoo/imagenet120/500_800/cos_lr/random', help='Path of the model zoo')
