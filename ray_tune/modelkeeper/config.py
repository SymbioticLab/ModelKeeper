...
# Path configuration
parser.add_argument('--zoo_path', type=str, default='/mnt/zoo/tests/model_zoo/', help='Path of the model zoo')
parser.add_argument('--execution_path', type=str, default='/mnt/zoo/tests/jobs/', help='Runtime data store of the framework')
parser.add_argument('--zoo_query_path', type=str, default='/mnt/zoo/tests/query_zoo/', help='Runtime data store of querying models')
parser.add_argument('--zoo_ans_path', type=str, default='/mnt/zoo/tests/ans_zoo/', help='Runtime data store of querying results')
