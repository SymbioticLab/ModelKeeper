...
static PyObject *__pyx_kp_u_Score_matrix_must_be_square;
...
static PyObject *__pyx_kp_s_chu_liu_edmonds_pyx;
 ...
 */
    __pyx_t_7 = (__pyx_v_score_matrix.shape[1]);
    __pyx_t_8 = __pyx_t_7;
 ...
 */
      __pyx_t_10 = __pyx_v_dep_i;
      __pyx_t_11 = __pyx_v_head_i;
      __pyx_t_12 = -1;
      if (__pyx_t_10 < 0) {
        __pyx_t_10 += __pyx_v_score_matrix.shape[0];
        if (unlikely(__pyx_t_10 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_10 >= __pyx_v_score_matrix.shape[0])) __pyx_t_12 = 0;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_v_score_matrix.shape[1];
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_Score_matrix_must_be_square, __pyx_k_Score_matrix_must_be_square, sizeof(__pyx_k_Score_matrix_must_be_square), 0, 1, 0, 0},
  ...
  {&__pyx_kp_s_chu_liu_edmonds_pyx, __pyx_k_chu_liu_edmonds_pyx, sizeof(__pyx_k_chu_liu_edmonds_pyx), 0, 0, 1, 0},
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_u_1_0_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
